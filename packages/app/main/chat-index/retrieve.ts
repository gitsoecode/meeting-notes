...
export interface SearchOptions extends SearchFilters {
  limit?: number;
  /** Supplied by the caller; retrieval doesn't own embedder state. */
...
export async function searchMeetings(
  ...
  if (isVecAvailable() && opts.queryEmbedder) {
    try {
...
export function getMeetingSummaryByRunId(
  ...
  try {
    // Lazy import to avoid pulling fs at module top-level if unused.
