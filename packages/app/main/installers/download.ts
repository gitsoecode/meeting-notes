...
import { streamToFileWithHash } from "./stream-to-file.js";
...
// `streamToFileWithHash` lives in `./stream-to-file.ts` so unit tests
// can import it without dragging in `paths.ts` → `electron`.
